...
extern int go_hostSetxattr(char *path, char *name, char *value, size_t size, int flags, uint32_t position);
extern int go_hostGetxattr(char *path, char *name, char *value, size_t size, uint32_t position);
...
static int _hostSetxattr(char *path, char *name, char *value, size_t size, int flags,
	uint32_t position)
{
	return go_hostSetxattr(path, name, value, size, flags, position);
}
static int _hostGetxattr(char *path, char *name, char *value, size_t size,
	uint32_t position)
{
	return go_hostGetxattr(path, name, value, size, position);
}
#else
static int _hostSetxattr(char *path, char *name, char *value, size_t size, int flags)
{
	return go_hostSetxattr(path, name, value, size, flags, 0);
}
static int _hostGetxattr(char *path, char *name, char *value, size_t size)
{
	return go_hostGetxattr(path, name, value, size, 0);
}
#endif
...
func go_hostSetxattr(path0 *c_char, name0 *c_char, buff0 *c_char, size0 c_size_t,
	flags c_int, position uint32) (errc0 c_int) {
	return hostSetxattr(path0, name0, buff0, size0, flags, position)
}

//export go_hostGetxattr
func go_hostGetxattr(path0 *c_char, name0 *c_char, buff0 *c_char, size0 c_size_t,
	position uint32) (nbyt0 c_int) {
	return hostGetxattr(path0, name0, buff0, size0, position)
}
