...
//
// See Service.SPGetParms in asp.go for the runtime implementation.
// ---------------------------------------------------------------------------
...
//
// Each type that the server parses from incoming packets has a
// ParseXxx(userData uint32, payload []byte) factory.
// Each type that the server marshals for outgoing packets has a
// MarshalUserData() uint32 method; types with an ATP data payload
// also have a MarshalData() []byte method.
// ===================================================================

// ---------------------------------------------------------------------------
// OpenSess — workstation → server (TReq to SLS)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// OpenSessReply — server → workstation (TResp to OpenSess TReq)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// CloseSess — workstation → server (TReq to SSS)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// CloseSessReply — server → workstation (TResp to CloseSess TReq)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// GetStatus — workstation → server (TReq to SLS)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Command — workstation → server (TReq to SSS)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Write — workstation → server (TReq to SSS, phase 1)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// WriteContinue — server → workstation WSS (TReq, phase 2)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Tickle — both directions (TReq, ALO, retry=infinite)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Attention — server → workstation WSS (TReq, ALO)
// ---------------------------------------------------------------------------
