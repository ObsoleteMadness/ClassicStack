...
type mockRouter struct {
	...
	routingConsiderFunc     func(entry *RouteEntry) bool
...
func (m *mockRouter) RoutingGetByNetwork(network uint16) (*RouteEntry, *bool) {
...
func (m *mockRouter) RoutingConsider(entry *RouteEntry) bool { return m.routingConsiderFunc(entry) }
