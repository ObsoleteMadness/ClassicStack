 ...
 * tools/end-to-end plan: the same core is meant to be lifted into the
 * Win16/Win32 SMB test tools with no changes here).
 */
#ifndef E2E_SCRIPT_H
#define E2E_SCRIPT_H
 ...
 * platform/mac_files.c over the Toolbox File Manager). */
 ...
 * live progress (e.g. a console window on Mac) without script.c knowing
 * anything about consoles/stdio/Toolbox. Pass NULL to disable. */
