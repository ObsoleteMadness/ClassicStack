// Code generated from Elliot Nunn's snefru_hash.py (NetBoot project); DO NOT EDIT
// by hand — regenerate with a table dump if the source changes.
//
// The tables are the first two standard Snefru S-boxes ("Tables For the Xerox
// Secure Hash Function", Xerox Corp., via Ralph C. Merkle's Snefru reference
// implementation). Apple's netboot hash (SuperMario os/netboot/Hash) and Elliot
// Nunn's Python port use only these two boxes.

package snefru

// sbox0 is standard Snefru S-box 0 (Xerox 'Tables For the Xerox Secure
// Hash Function', via Elliot Nunn's snefru_hash.py / Apple's Hash.a).
...
// sbox1 is standard Snefru S-box 1 (Xerox 'Tables For the Xerox Secure
// Hash Function', via Elliot Nunn's snefru_hash.py / Apple's Hash.a).
